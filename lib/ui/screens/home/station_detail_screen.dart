...
class StationDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<_SlotView> availableSlotViews = station.slots
    ...
    final availableBikes = availableSlotViews.length;
                  ...
                  children: [
                    ...
                    if (availableSlotViews.isEmpty)
                      ...
                      GridView.builder(
                        ...
                        itemCount: availableSlotViews.length,
                        ...
                        itemBuilder: (context, index) => _ModernSlotCard(
                          slot: availableSlotViews[index],
                          onTap: () {
                            _showBookingConfirmationSheet(
                              context,
                              availableSlotViews[index],
                            );
                          },
                        ),
                      ),
  ...
  void _showBookingConfirmationSheet(BuildContext context, _SlotView slot) {
...
class _ModernSlotCard extends StatelessWidget {
  final _SlotView slot;
  final VoidCallback onTap;

  const _ModernSlotCard({required this.slot, required this.onTap});
